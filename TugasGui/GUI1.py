...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        # Menggunakan layout MainWindow dengan ukuran 630 x 611
        ...
        #text NIM menggunakan komponen label
        self.label_2.setObjectName("label_2")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(160, 370, 361, 21))
        self.lineEdit.setText("")
        # text Nama menggunakan komponen label
        # Input data menggunakan komponen line edit
        ...
        font.setWeight(75)
        # Input data menggunakan komponen line edit
        #Text Jurusan dengan menggunakan label
        ...
        font.setBold(True)
        font.setWeight(75)
        # Text No.Telp menggunakan komponen label
        ...
        self.textBrowser.setGeometry(QtCore.QRect(100, 80, 421, 271))
